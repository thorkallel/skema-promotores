    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12 px-0">               
                ...
                if ($url_img) : ?>
                    <img src="<?php echo esc_url($url_img); ?>" alt="<?php echo esc_attr( $banner_alt ); ?>" class="w-100 img-fluid d-none d-sm-block">       
                <?php endif; ?>   
                <?php $banner_movil = get_field('banner_movil');
                if ($banner_movil) : ?>
                    <img src="<?php echo esc_url($banner_movil); ?>" alt="<?php echo esc_attr( $banner_alt ); ?>" class="img-fluid d-sm-none d-block w-100">
                <?php endif; ?> 
                <div class="card-img-overlay p-sm-5 px-5 d-flex align-items-sm-center align-items-end  justify-content-sm-start justify-content-center w-100">
        ...
        <div class="row mt-sm-5 mt-4 justify-content-between">
            ...
            <div class="col-sm-6 col-12 text-sm-right text-center align-self-center mb-4 mb-sm-0">
                ...
                if (!empty($estado) && !is_wp_error($estado)) { ?>
                    <p class="m-0">Estado del proyecto: <span class="ml-sm-4 ml-3 estado-proyecto"><?php echo esc_html($estado[0]->name); ?></span></p>
                <?php } ?>
            </div>            
        </div>
    </div>
                ...
                <ul class="nav text-center justify-content-between" id="myTab" role="tablist">
                    <?php if(get_field('area_const') || get_field('area_priv')): ?>  
                        <li class="col-sm-4 col-5 px-0 px-sm-3">
                            <a href="#caract" class="nav-link btn-catego active" data-toggle="tab" role="tab" aria-controls="caract" aria-selected="true">
                                Caracteristicas
                            </a>
                    ...
                    <?php if(get_field('imagenes')): ?>
                        <li class="col-sm-4 col-5 px-0 px-sm-3">
                             <a href="#zonas" class="nav-link btn-catego" data-toggle="tab" role="tab" aria-controls="zonas" aria-selected="false">
                                Zonas comunes
                            </a>
                        </li>
                    <?php endif; ?>
                                ...
                                <?php if(get_field('imagenes')): ?>
                                    ...
                                    <div class="slider-zonas">
										...
										foreach ( $galeria as $img_url ) :
											...
											?>
                                            <div><img src="<?= esc_url($img_url); ?>" class="img-fluid w-100" alt="<?php echo esc_attr( $alt_zona ); ?>"></div>
                                        <?php
											$iz++;
										endforeach; ?>
                                    </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row justify-content-center">
                <div class="col-sm-11 px-sm-5">              
                    <div class="slider_project row justify-content-center" data-projects-count="<?= count(get_posts(array('post_type' => 'proyectos', 'tax_query' => array(array('taxonomy' => 'tipo_proyecto', 'field' => 'slug', 'terms' => $tipo_slug))))) ?>">
                                ...
                                <div class="hover-infoproyecto px-sm-5 px-4 pt-sm-4 pb-sm-5">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-5 col-12 align-self-center py-sm-5 py-0 text-center">
                                            ...
                                            <img class="img-fluid w-75 mt-sm-4 mt-2 d-none d-sm-block rounded-0" src="<?php echo get_template_directory_uri() ?>/img/logo-skema.png" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-sm-11 px-sm-0">
                <?php if (have_rows('avance')) :
                    ...
                    while (have_rows('avance')) : the_row();
                        ...
                        <div class="avance-galeria <?= $i == 0 ? 'active' : ''; ?>" id="avance-<?php echo $i; ?>" style="<?= $i != 0 ? 'display:none;' : ''; ?>">
                            <div class="slider-avance">
								...
								foreach ( $galeria as $img_url ) :
									...
									?>
                                    <div><img src="<?= esc_url($img_url); ?>" class="img-fluid w-100" alt="<?php echo esc_attr( $alt_av ); ?>"></div>
                                <?php
									$ia++;
								endforeach; ?>
                            </div>
