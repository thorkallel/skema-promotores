...
$output .= "{$n}{$indent}<ul$class_names $labelledby>{$n}";
    ...
    */
    ...
    // .nav-item solo en raíz del navbar; dentro de dropdowns rompe el layout de subniveles.
    if ( 0 === $depth ) {
    $classes[] = 'nav-item';
    }
    ...
    * @param string $menu_id The ID that is applied to the menu item's `<li>` element.
    ...
    <li ' . $id . $class_names . '>';
        ...
        // If the item has_children add atts to <a>.
            ...
            // Bootstrap 4.x (tema carga bootstrap.bundle v4.6): usa data-toggle, no data-bs-toggle (BS5).
            ...
            */
			...
			// Icon markup before the title when icon classes exist.
			$icon_html = '';
