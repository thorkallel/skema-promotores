        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                ...
                if ($banner_movil) : ?>
                    ...
                    <?php endif; ?>
                    <div
                        class="card-img-overlay p-sm-5 d-flex align-items-sm-center align-items-end justify-content-start w-100">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-sm-3 col-6 px-sm-3 px-2 pb-sm-0 pb-4">
                            <div class="card px-sm-4 px-2 py-3 pb-sm-4 pt-sm-5 h-100">
                                <?php if ($url_img) : ?>
                                <img src="<?php echo esc_url($url_img); ?>" alt="Icono"
                                    class="w-25 mb-sm-3 mb-2 mx-auto mx-sm-0">
                                <?php endif; ?>
                ...
                <div class="col-sm-10 col-12">
                    ...
                    foreach ($terms as $index => $term) { ?>
                        <li class="col-sm-3 col-6 mb-4 mb-sm-0">
                            <a href="#<?= $term->slug; ?>"
                                class="nav-link btn-catego <?php echo ($index== 0)?'active':''; ?>" data-toggle="tab"
                                role="tab" aria-controls="<?= $term->slug ?>"
            ...
            <div class="row">
                ...
                <div class="col-sm-10 col-12 py-sm-0 py-5 px-sm-0">
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade <?= $index == 0 ? 'show active' : '' ?>" id="<?= $term->slug ?>"
                            role="tabpanel">
                            <div class="row">
                                ...
                                <div class="col-6 px-2 d-flex justify-content-start pr-sm-5">
                                    <div class="timeline-container position-relative w-100 align-self-center">
                                        <!-- Flechas -->
                                        <div
                                            class="timeline-arrows d-none d-sm-flex flex-column align-items-center position-absolute">
                                            <div class="arrow-up cursor-pointer mb-2">
                                                <?php echo file_get_contents(get_template_directory() . '/img/f-arriba.svg'); ?>
                                            </div>
                                            <div class="arrow-down cursor-pointer">
                                                <?php echo file_get_contents(get_template_directory() . '/img/f-abajo.svg'); ?>
                                            </div>
                                        </div>
                                        <!-- Timeline Scroll -->
                                        <div class="timeline-scroll overflow-auto ml-sm-5 pl-sm-4"
                                            ...
                                            <div class="timeline-years">
                                                ...
                                                <div class="timeline-year-block mb-4">
                                                    <div class="d-flex">
                                                        <div
                                                            class="timeline-line d-flex flex-column align-items-center position-relative">
                                                            <span class="timeline-dot big"></span>
                                                            <div class="timeline-line-inner position-absolute mr-4"
                                                                style="top: 12px; bottom:-25px;left:-3px;width: 2px; background-color: #002f87;">
                                                            </div>
                                                        </div>
                                                        <div class="div_info_anos">
                                                            <h4 class="font-weight-bold d-block ml-4 mb-0 pl-sm-2">
                                                                <?php the_sub_field('ano'); ?></h4>
                                                            <?php if ( have_rows( 'proyectos' ) ) :
                                                                        $c = 0;
                                                                        while ( have_rows( 'proyectos' ) ) :
                                                                            the_row();
                                                                            $proy_raw       = theme_skema_timeline_get_proy_raw();
                                                                            $timeline_title = theme_skema_timeline_get_proyecto_title( $proy_raw );
                                                                            if ( $timeline_title === '' ) {
                                                                                continue;
                                                                            }
                                                                            $timeline_post_id = theme_skema_timeline_resolve_proyecto_post_id( $proy_raw );
                                                                            $timeline_ciudad  = theme_skema_timeline_get_ciudad_label(
                                                                                $timeline_post_id,
                                                                                get_sub_field( 'ciu-m' )
                                                                            );
                                                                            ?>
                                                            <div class="d-flex mb-4">
                                                                ...
                                                                <div class="pl-sm-2 <?= $c !== 0 ? 'pl-2' : 'pl-4' ?>">
                                                                    <p class="m-0">
                                                                        <b><?php echo esc_html( $timeline_title ); ?></b>
                                                                    </p>
                                                                    <?php if ( $timeline_ciudad !== '' ) : ?>
                                                                    <p class="m-0">
                                                                        <?php echo esc_html( $timeline_ciudad ); ?></p>
                                                                    <?php endif; ?>
                                                                </div>
                                                            </div>
                                                            <?php
                                ...
                                <div class="col-6">
                                    <div class="d-flex flex-wrap rounded overflow-hidden">
                                        ...
                                        <div class="div_imgs" style="">
                                            <img src="<?= esc_url($img); ?>" class="img-fluid w-100 <?= $clase_borde ?>"
                                                alt="Proyecto">
                                        </div>
                                        <?php endforeach;
                                        endif; ?>
        ...
        <div class="container-fluid px-sm-5">
            ...
            <div class="row justify-content-center px-sm-5 mb-sm-5">
                ...
                <div class="col-sm-6 col-12 pl-sm-5 pr-sm-2">
                    <img class="w-100 mb-3 mb-sm-0" src="<?php the_sub_field('img') ?>"
                        alt="<?php echo esc_attr( wp_strip_all_tags( get_sub_field( 'tt' ) ) ); ?>">
                </div>
